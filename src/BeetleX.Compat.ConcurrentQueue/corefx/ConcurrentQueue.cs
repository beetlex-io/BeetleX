...
namespace BeetleX.Dispatchs
{
    ...
    public partial class ConcurrentQueueX<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
    {
        ...
        public ConcurrentQueueX(IEnumerable<T> collection)
        {
            if (collection == null)
            {
        ...
        object ICollection.SyncRoot { get { throw new NotSupportedException("The SyncRoot property may not be used for the synchronization of concurrent collections."); } }
        ...
        public void CopyTo(T[] array, int index)
        {
            ...
            if (index < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(index), "The index argument must be greater than or equal zero.");
            }
